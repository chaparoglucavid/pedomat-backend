                ...
                <div class="card card-h-100 mt-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0">Yeni PED Kateqoriya</h4>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('ped-categories.store') }}">
                            @csrf
                            <div class="row g-4">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea placeholder="İstifadə səbəbini daxil edin" name="reason_for_use"
                                              id="reason-for-use" class="form-control" rows="3">{{ old('reason_for_use') }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        ...
                                        <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>Deaktiv</option>
                                    </select>
                                </div>
                            </div>
