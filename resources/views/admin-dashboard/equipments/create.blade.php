                ...
                <div class="card card-h-100 mt-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0">Yeni cihaz məlumatları</h4>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input placeholder="Cihaz adını daxil edin" name="equipment_name" type="text"
                                           id="equipment-name" class="form-control" value="{{ old('equipment_name') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input placeholder="Cihaz nömrəsini daxil edin" name="equipment_number" type="text"
                                           id="equipment-number" class="form-control" value="{{ old('equipment_number') }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label" for="general-capacity">Ümumi tutum</label>
                                    <input placeholder="Məs: 20" name="general_capacity" type="number"
                                           id="general-capacity" class="form-control" value="{{ old('general_capacity') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="equipment-status" name="equipment_status">
                                        ...
                                        <option value="active" {{ old('equipment_status') == 'active' ? 'selected' : '' }}>Aktiv</option>
                                        <option value="inactive" {{ old('equipment_status') == 'inactive' ? 'selected' : '' }}>Deaktiv</option>
                                        <option value="maintenance" {{ old('equipment_status') == 'maintenance' ? 'selected' : '' }}>Servisdə</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input placeholder="Cari ünvanı daxil edin" name="current_address" type="text"
                                           id="current-address" class="form-control" value="{{ old('current_address') }}">
                                </div>
